...
template<typename pixel_t>
void func_0_avx512(VSFrame * src[3], VSFrame * dst, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept {
...
template<typename pixel_t>
void func_1_avx512(VSFrame * src[15][3], VSFrame * dst, const int pos, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept {
    const float * hw = d->hw.get();
    const float * sigmas = d->sigmas.get();
    const float * sigmas2 = d->sigmas2.get();
    const float * pmins = d->pmins.get();
...
template void func_0_avx512<uint8_t>(VSFrame * src[3], VSFrame * dst, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept;
template void func_0_avx512<uint16_t>(VSFrame * src[3], VSFrame * dst, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept;
template void func_0_avx512<float>(VSFrame * src[3], VSFrame * dst, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept;

template void func_1_avx512<uint8_t>(VSFrame * src[15][3], VSFrame * dst, const int pos, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept;
template void func_1_avx512<uint16_t>(VSFrame * src[15][3], VSFrame * dst, const int pos, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept;
template void func_1_avx512<float>(VSFrame * src[15][3], VSFrame * dst, const int pos, const DFTTestData * const VS_RESTRICT d, const VSAPI * vsapi) noexcept;
#endif
